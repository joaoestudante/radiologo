...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    ist_student_number  = models.CharField(verbose_name = _("IST Student Number"), max_length=15, unique=True, null=True, blank=True)
    phone          = models.CharField(verbose_name = _("Phone"), max_length=9, unique=True)
